...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <?php 
            include("config.php");
            $query = mysqli_query($conn, "SELECT * from ico1 WHERE status='approved'");
              ...
              <tr>
                 ...
                 <td>
                    ...
                    <div class="btn-group">
                      ...
                      <a onClick="return confirm('Please check for confirmation.');" href="send_acc_mail_p.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">CONFIRM</a>
                      <a onClick="return confirm('Please check for non confirmation.');" href="nonconfirm.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary">NOT CONFIRM</a>
